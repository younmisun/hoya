...
//console.log($.fn.myHidden); //$.fn은 jQuery의 버전을 확인할 수도 있지만, 
//자바스크립트의 기본 기능에 강제로 새로운(내가만든) 기능을 삽입하는 명령문이기도 함

/* $.fn.myHidden = function(c){ //c라는 매개변수
  let myC = c;
  let myView = 'hidden';
...
$.fn.mySlide = function(){
  ...
  const slide = this; //('#miniProduct')을 지칭하는 것
