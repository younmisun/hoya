...
(function($){
  ...
  conDt.children('button').on('click focus', function(e){
    ...
    ->여러번 반복적으로 클릭했을 경우 갑자기 하얀색으로 변하는 오류가 생김. 일단 보류! 
  ...
  const mediaList = [{text:'[Youtube] 아마존으로 2600억 매출',date:'2019.10.22',img:'media_01.jpg'},
                    {text:'슈피겐코리아 미국 아마존 독점유통',date:'2019.10.20',img:'media_02.jpg'},
                    {text:'[Youtube] \'취업비자\' 기업탐방',date:'2019.10.10',img:'media_03.jpg'}];
      
  const blogList = [{text:'[Youtube] 아마존으로 2600억 매출',date:'2019.10.22',img:'media_01.jpg'},
                     {text:'슈피겐코리아 미국 아마존 독점유통',date:'2019.10.20',img:'media_02.jpg'},
                     {text:'[Youtube] \'취업비자\' 기업탐방',date:'2019.10.10',img:'media_03.jpg'}];
                     //요소 중 하나를 원한다면 mediaList[0].text
    // const blogList = ;
    ...
    // for(최초의 값;조건비교;값의증감){}
    // 최초의 값이 조건 비교했을 때 참이게 되면 조건을 수행한다.
